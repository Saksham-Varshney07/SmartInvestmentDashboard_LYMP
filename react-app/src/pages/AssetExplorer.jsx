  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center p-6 text-center antialiased font-['Inter']">
      <div>
        ...
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Asset Explorer</h1>
        <p className="text-slate-500 mb-6 max-w-md mx-auto">This module is currently under construction. Explore various mutual funds, stocks, and crypto market insights here.</p>
